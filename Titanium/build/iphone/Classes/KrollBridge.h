...
@interface BustinOutObject : KrollCoverageObject {
#else
@interface BustinOutObject : KrollObject {
#endif
@private
...
extern NSString * BustinOut$ModuleRequireFormat;

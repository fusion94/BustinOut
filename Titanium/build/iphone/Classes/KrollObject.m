...
//@interface BustinOutObject : NSObject
//@end

@interface BustinOutObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[BustinOutObject class]])
		{
			for (NSString *key in [[(BustinOutObject*)o modules] allKeys])
			{

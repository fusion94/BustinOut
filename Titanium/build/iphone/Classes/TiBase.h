...
// in simulator we redefine to format for BustinOut Developer console
...
{\
	NSString * exceptionName = [@"org.bustinout." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.bustinout";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIBustinOutNativeItemNone = -1, 
	UIBustinOutNativeItemSpinner = -2,
	UIBustinOutNativeItemProgressBar = -3,
	
	UIBustinOutNativeItemSlider = -4,
	UIBustinOutNativeItemSwitch = -5,
	UIBustinOutNativeItemMultiButton = -6,
	UIBustinOutNativeItemSegmented = -7,
	
	UIBustinOutNativeItemTextView = -8,
	UIBustinOutNativeItemTextField = -9,
	UIBustinOutNativeItemSearchBar = -10,
	
	UIBustinOutNativeItemPicker = -11,
	UIBustinOutNativeItemDatePicker = -12,
	
	UIBustinOutNativeItemInfoLight = -13,
	UIBustinOutNativeItemInfoDark = -14,
	
	UIBustinOutNativeItemDisclosure = -15,
	
	UIBustinOutNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all BustinOut instances of

...
/**
 Base class for all BustinOut views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the BustinOut view hierarchy (such as wrapped iOS UIViews) was touched.
